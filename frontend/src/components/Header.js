              ...
              <div class="p-4">
                <div class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm/6 hover:bg-gray-50">
                  ...
                  <div class="flex-auto">
                    ...
                    <p class="mt-1 text-gray-600">Generate book recommendations</p>
                  </div>
                </div>
                <div class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm/6 hover:bg-gray-50">
                  <div class="flex size-11 flex-none items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white">
                  ...
                  <div class="flex-auto">
                    ...
                    <p class="mt-1 text-gray-600">Find news articles</p>
                  </div>
                </div>
                <div class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm/6 hover:bg-gray-50">
                  <div class="flex size-11 flex-none items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white">
                  ...
                  <div class="flex-auto">
                    <a href="/anki" class="block font-semibold text-gray-900">
                      Anki
                      <span class="absolute inset-0"></span>
                    </a>
                    <p class="mt-1 text-gray-600">View your Anki decks</p>
                  </div>
                </div>
                </div>
            </el-popover>
